...
class GmspIntegrationTest {
    ...
    /**
     * Test that we can search for instances using the SECOM search service API
     * endpoint that supports Lucene queries and a paged result. The search is globally propagated using GMSP
     * In this test the optional WKT geometry has been omitted
     */
    @Test
