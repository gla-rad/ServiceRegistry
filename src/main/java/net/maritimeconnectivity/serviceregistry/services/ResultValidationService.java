...
/**
 * Service implementation for validating search results obtained from local and global search
 ...
 * focuses on validating the content of the results, not the signature!
